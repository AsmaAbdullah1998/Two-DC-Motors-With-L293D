...
* Powering a series circuit: The total voltage of the circuit is the sum of the voltages across each LED. This means you have to supply, at minimum, the sum of the forward voltages of each LED.
